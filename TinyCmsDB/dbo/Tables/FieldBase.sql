CREATE TABLE [dbo].[FieldBase] (
    [Id]                   UNIQUEIDENTIFIER CONSTRAINT [DF_FieldBase_Id] DEFAULT (newid()) NOT NULL,
    ...
    [ListProviderId]       UNIQUEIDENTIFIER NULL,
    [ListDefinition]       VARCHAR (400)    NULL,
    ...
    CONSTRAINT [FK_FieldBase_ListProvider] FOREIGN KEY ([ListProviderId]) REFERENCES [dbo].[ListProvider] ([Id]) ON DELETE SET NULL ON UPDATE CASCADE
);
