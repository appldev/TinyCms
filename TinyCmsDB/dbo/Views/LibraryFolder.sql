CREATE VIEW dbo.LibraryFolder
AS
WITH Folders AS (SELECT        l.Id, l.ParentId, l.LibraryId, l.Name, l.Title, l.Description, 0 AS FolderLevel, CAST(lib.PathRoot AS varchar(400)) AS FolderPath
                                       FROM            dbo.LibraryFolderBase AS l INNER JOIN
                                                                dbo.Library AS lib ON l.LibraryId = lib.Id
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'LibraryFolder';
